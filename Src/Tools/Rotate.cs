...
internal sealed class Rotate : ITuul
{
    internal enum RotateMethod
    {
        Ninety,
        OneEighty,
        TwoSeventy
    ...
    string ITuul.Name => "Rotate a picture";
    string ITuul.UrlName => "rotate";
    string ITuul.Keywords => "rotate turn flip picture image photo";
    string ITuul.Description => "Rotates a picture you upload.";
    string ITuul.Js => null;
    string ITuul.Css => null;

    private static readonly ReadOnlyCollection<RotateMethod> _allowed = Array.AsReadOnly(new[] { RotateMethod.Ninety, RotateMethod.OneEighty, RotateMethod.TwoSeventy });
