...
{
    sealed class RankingComparison : ITuul
    {
        bool ITuul.Enabled { get { return true; } }
        bool ITuul.Listed { get { return true; } }
        string ITuul.Name { get { return "Rank compare"; } }
        string ITuul.UrlName { get { return "rankcompare"; } }
        string ITuul.Keywords { get { return "list ranking compare comparison visualize visualization picture graphic image boxes curves red yellow green"; } }
        string ITuul.Description { get { return "Compares two lists that represent rankings of things (for example, episodes of a show ranked by personal preference; games ranked by difficulty; etc.) and shows the similarities and differences visually."; } }
